...
const OurWorkPage = () => {
  ...
  return (
    <div className='card-container w-full h-fit'>
      ...
      <div className="w-full max-w-7xl m-auto px-16">
        <div className="relative overflow-hidden">
          <ul className="mt-24 mb-12 flex cursor-grab overflow-x-auto whitespace-nowrap scrollbar-hidden">
        ...
        <div className="flex justify-flex items-end flex-wrap pb-20">
          {filteredCards.map((card, index) => (
            <div key={index} className="card relative xl:m-auto mx-3 overflow-hidden rounded-md pb-2 group">
