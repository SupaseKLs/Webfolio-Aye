  ...
  return (
    <>
          ...
          <div className="pl-4">
            <div className="sm:w-[370px] w-[440px]">
              ...
              <p className="sm:text-sm indent-8 pt-4">
                ...
                experience are include product design, graphic design and UXUI.
                All of the project are based on art and design knowledge with
                critical analysis on users, 5W1H, suitable function and design
                and more. UXUI and product design share some similarities which
                I can learn swiftly and efficiently. I am looking forward to
                work in UX/UI field from now on. Most importantly I still
                willing to learn new technique and improve my skill.
              </p>
            </div>
            <div className="sm:pt-4 pt-10">
              <h1 className="sm:text-xl text-primary-color">Education</h1>
              <p className="sm:text-sm">
                Slipakorn University, Faculty of Decorative Arts, Product design
              </p>
            </div>
            <div className="sm:pt-4 pt-10">
      ...
      <div className="relative">
        <Image src={HalfCircle} className="max-w-full h-full" />
        <div className="bg-primary-color h-[450px]"></div>
        <div className="xl:max-w-2xl sm:max-w-md max-w-6xl m-auto">
          <div className="absolute sm:p-10 sm:top-16 top-24">
            <h1 className="sm:text-3xl text-7xl text-content-color">
              KEEP IN TOUCH
            </h1>

            <div className="mt-10 grid sm:grid-cols-0 grid-cols-7 gap-4 sm:max-w-md xl:max-w-2xl max-w-6xl m-auto">
              <div className="col-span-1 pt-4 pl-2 text-left text-content-color font-bold">
                SOCIALS
              </div>
              <div className="col-span-1 pt-4 sm:pl-14 pl-2 text-left text-content-color font-bold">
                EMAIL
              </div>
              <div className="col-span-1 p-2 text-center"></div>
              <div className="col-span-4 p-2 text-center"></div>
              <div className="col-span-1 pl-2 text-left">
                <Link href="" className="text-content-color underline">
                  Linkedin
                </Link>
              </div>
              <div className="col-span-1 pl-2  sm:pl-14 text-left text-content-color underline">
                chanikarn.aye@gmail.com
              </div>
              <div className="col-span-1 p-2 text-center"></div>
              <div className="col-span-4 p-2 text-center"></div>
              <div className="col-span-1 pl-2 text-left">
                <Link className="text-content-color underline" href="">
                  Behance
                </Link>
              </div>
              <div className="col-span-1 p-2 text-center"></div>
              <div className="col-span-1 p-2 text-center"></div>
              <div className="col-span-4 pt-5 text-right text-content-color text-3xl">
                @2024
              </div>
              <div className="col-span-1 p-2 text-center"></div>
              <div className="col-span-1 p-2 text-center"></div>
              ...
              <div className="col-span-4 flex justify-end">
                <div className="flex bg-content-color rounded-full border-[#AFACAA] border-4 px-6 py-2">
                  <Link
                    className="uppercase text-[#AFACAA] text-sm underline"
                    href=""
                  >
                    Resume
                  </Link>
